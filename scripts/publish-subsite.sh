...
#
#   site-name   只允许 briefs | openrouter | ai-news | research | token-gpu
...
case "$SITE" in
  briefs|openrouter|ai-news|research|token-gpu) ;;
  *) die "不支持的 site-name: '$SITE'（只允许 briefs | openrouter | ai-news | research | token-gpu）" ;;
esac
